...
import type { EmbedDescriptor, ToastType } from './types'
...
// nodes
import type ReactNode from './nodes/ReactNode'
...
import { styled, ThemeProvider } from '@fxtrot/ui'
...
class RichMarkdownEditor extends React.PureComponent<Props, State> {
  ...
  render = () => {
    const { readOnly, readOnlyWriteCheckboxes, tooltip, onKeyDown } = this.props
    const dictionary = this.dictionary(this.props.dictionary)

    return (
      <Flex onKeyDown={onKeyDown} main="start" cross="center">
        <ThemeProvider>
          <>
            <StyledEditor
              readOnly={readOnly}
